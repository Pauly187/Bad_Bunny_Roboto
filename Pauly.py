...
m_r.run_timed(time_sp=1250, speed_sp=500)
m_r.wait_while('running')
#90° turn left
m_l.run_timed(time_sp=1000, speed_sp=500)
m_r.run_timed(time_sp=1000, speed_sp=500)
...
m_l.run_timed(time_sp=1250, speed_sp=500)
m_l.wait_while('running')
#90° trun right (untenlinks)
m_l.run_timed(time_sp=2300, speed_sp=500)
m_r.run_timed(time_sp=2300, speed_sp=500)
m_l.wait_while('running')
m_r.wait_while('running')
